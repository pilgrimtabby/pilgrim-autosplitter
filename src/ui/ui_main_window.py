...
class UIMainWindow(QMainWindow):
    ...
    def _show_minimal_view(self, splitter_paused: bool):
        ...
        self.current_match_percent.setGeometry(QRect(227 + self.LEFT_EDGE_CORRECTION, 304 + self.TOP_EDGE_CORRECTION, 46, 31))
        self.highest_match_percent.setGeometry(QRect(227 + self.LEFT_EDGE_CORRECTION, 331 + self.TOP_EDGE_CORRECTION, 46, 31))
        self.threshold_match_percent.setGeometry(QRect(227 + self.LEFT_EDGE_CORRECTION, 358 + self.TOP_EDGE_CORRECTION, 46, 31))
    ...
    def _show_480x360_view(self, splitter_paused: bool):
        ...
        self.current_match_percent.setGeometry(QRect(245 + self.LEFT_EDGE_CORRECTION, 680 + self.TOP_EDGE_CORRECTION, 46, 31))
        self.highest_match_percent.setGeometry(QRect(245 + self.LEFT_EDGE_CORRECTION, 710 + self.TOP_EDGE_CORRECTION, 46, 31))
        self.threshold_match_percent.setGeometry(QRect(245 + self.LEFT_EDGE_CORRECTION, 740 + self.TOP_EDGE_CORRECTION, 46, 31))
    ...
    def _show_320x240_view(self, splitter_paused: bool):
        ...
        self.current_match_percent.setGeometry(QRect(115 + self.LEFT_EDGE_CORRECTION, 560 + self.TOP_EDGE_CORRECTION, 46, 31))
        self.highest_match_percent.setGeometry(QRect(115 + self.LEFT_EDGE_CORRECTION, 590 + self.TOP_EDGE_CORRECTION, 46, 31))
        self.threshold_match_percent.setGeometry(QRect(115 + self.LEFT_EDGE_CORRECTION, 620 + self.TOP_EDGE_CORRECTION, 46, 31))
    ...
    def _show_512x288_view(self, splitter_paused: bool):
        ...
        self.current_match_percent.setGeometry(QRect(245 + self.LEFT_EDGE_CORRECTION, 608 + self.TOP_EDGE_CORRECTION, 46, 31))
        self.highest_match_percent.setGeometry(QRect(245 + self.LEFT_EDGE_CORRECTION, 638 + self.TOP_EDGE_CORRECTION, 46, 31))
        self.threshold_match_percent.setGeometry(QRect(245 + self.LEFT_EDGE_CORRECTION, 668 + self.TOP_EDGE_CORRECTION, 46, 31))
    ...
    def _show_432x243_view(self, splitter_paused):
        ...
        self.current_match_percent.setGeometry(QRect(245 + self.LEFT_EDGE_CORRECTION, 563 + self.TOP_EDGE_CORRECTION, 46, 31))
        self.highest_match_percent.setGeometry(QRect(245 + self.LEFT_EDGE_CORRECTION, 593 + self.TOP_EDGE_CORRECTION, 46, 31))
        self.threshold_match_percent.setGeometry(QRect(245 + self.LEFT_EDGE_CORRECTION, 623 + self.TOP_EDGE_CORRECTION, 46, 31))
