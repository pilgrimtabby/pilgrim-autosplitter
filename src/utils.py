...
if settings.value("SETTINGS_SET") is None:
    ...
    settings.setValue("SPLIT_HOTKEY", "")
    settings.setValue("RESET_HOTKEY", "")
    settings.setValue("PAUSE_HOTKEY", "")
    settings.setValue("UNDO_HOTKEY", "")
    settings.setValue("SKIP_HOTKEY", "")
    settings.setValue("SCREENSHOT_HOTKEY", "")
