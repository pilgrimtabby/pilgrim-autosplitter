...
class SplitImage:
    ...
    def __init__(self, image_path) -> None:
        ...
        self.delay_duration = self.get_delay_from_name()
        self.pause_duration = self.get_pause_from_name()
        self.threshold = self.get_threshold_from_name()
        self.loop_count = self.get_loop_count_from_name()
